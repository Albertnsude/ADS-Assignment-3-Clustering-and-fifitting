...
"""
creating a def function polynomial for the world population datasets and returns
dataframes with index:one with years as columns
...
"""
creating a def model function and error ranges for computation and calculation
